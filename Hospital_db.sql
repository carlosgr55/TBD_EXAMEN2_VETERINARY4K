...
--
-- Host: localhost    Database: examen_eva2
-- ------------------------------------------------------
...
INSERT INTO `direcciones_pacientes` VALUES (1,1,73),(2,2,39),(3,3,70),(4,4,4),(5,5,41),(6,6,56),(7,7,10),(8,8,45),(9,9,3),(10,10,9),(11,11,55),(12,12,51),(13,13,81),(14,14,61),(15,15,36),(16,16,42),(17,17,91),(18,18,24),(19,19,17),(20,20,67),(21,21,79),(22,22,46),(23,23,5),(24,24,65),(25,25,43),(26,26,20),(27,27,89),(28,28,64),(29,29,75),(30,30,47),(31,31,33),(32,32,13),(33,33,19),(34,34,78),(35,35,49),(36,36,52),(37,37,26),(38,38,57),(39,39,71),(40,40,23),(41,41,1),(42,42,7),(43,43,2),(44,44,69),(45,45,27),(46,46,50),(47,47,40),(48,48,28),(49,49,88),(50,50,80),(51,51,18),(52,52,62),(53,53,83),(54,54,63),(55,55,14),(56,56,72),(57,57,12),(58,58,48);
...
CREATE TABLE `registro_pacientes` (
  ...
  CONSTRAINT `registro_pacientes_ibfk_2` FOREIGN KEY (`cuentas_pacientes_id`) REFERENCES `cuentas_pacientes` (`cuentas_pacientes_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
-- Dump completed on 2024-11-09 17:10:43
